...
isTrip:any;
  ...
  constructor(public navCtrl: NavController,public sendFeedbackService:sendFeedbackService,public toastCtrl:ToastController,public SignUpService: SignUpService,public alertCtrl:AlertController,public actionSheetCtrl:ActionSheetController,public chatsService:chatsService,public navParams: NavParams,private AngularFireAuth: AngularFireAuth) {
    ...
    this.SignUpService.getMyInfoForProfile(this.SignUpService.userUniversity,this.userUid).takeUntil(this.unsubscribe).subscribe(info =>{
      this.user = info
      ...
      let alert = this.alertCtrl.create({
        ...
        buttons: [
          ...
          },
          {
            text: 'Reportar',
            handler: () => {
            this.sendFeedbackService.sendFeedback(this.SignUpService.userUniversity,'Reporte_de_chat',this.chats,this.user.name,this.user.lastname,this.user.phone,this.userUid)               
