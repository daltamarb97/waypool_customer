...
var FindridePassPage = /** @class */ (function () {
    function FindridePassPage(navCtrl, MetricsService, geolocation, zone, sendCoordsService, AngularFireAuth, alertCtrl, geofireService, SignUpService, modalCtrl, app, afDB, TripsService, instanceService, platform, fcm, firebase, loadingCtrl, viewCtril) {
        ...
        this.afDB.database.ref('allUsers/' + this.userUid).once('value').then(function (snap) {
            ...
            _this.afDB.database.ref('/usersTest/' + _this.userUid).once('value').then(function (snapWalkthr) {
            ...
            _this.instanceService.isVerified(_this.userUid);
            _this.afDB.database.ref('/usersTest/' + _this.userUid + '/myReserves/').once('value').then(function (snapReserve) {
                if (snapReserve.val()) {
                    ...
                    if (_this.user.onTrip == true) {
                        ...
                        try {
                            ...
                            if (_this.autocompleteMyDest.input == '' || _this.autocompleteMyPos.input == '') {
                                ...
                                //  this.setGeofirePlaceWithDest(this.geofirePlaceSize, this.myLatLngDest.lat(), this.myLatLngDest.lng(), this.userUid);
                                ...
                                //                  this.setGeofireOr( 2, this.myLatLngOr.lat, this.myLatLngOr.lng, this.userUid)
                                //                  this.setGeofireOrLMU( 2, this.myLatLngOr.lat, this.myLatLngOr.lng, this.userUid)
                                ...
                                //  if(this.usingGeolocation === true){
                                //    this.setGeofirePlaceWithOr(this.geofirePlaceSize, this.myLatLngOr.lat, this.myLatLngOr.lng, this.userUid);
                                //  }else{
                                //    this.setGeofirePlaceWithOr(this.geofirePlaceSize, this.myLatLngOr.lat(), this.myLatLngOr.lng(), this.userUid);
                                //  }
                                //  console.log(this.thereAreReserves);
                                ...
                                //                this.setGeofireDest( 2, this.myLatLngDest.lat(), this.myLatLngDest.lng(), this.userUid)
                                //                this.setGeofireDestLMU( 2, this.myLatLngDest.lat(), this.myLatLngDest.lng(), this.userUid)
    ...
    FindridePassPage.prototype.setGeofirePlaceWithDest = function (radius, lat, lng, userId) {
    ...
    // set geoquery that determines if the person is in place
    FindridePassPage.prototype.setGeofirePlaceWithOr = function (radius, lat, lng, userId) {
        this.dbRef = this.afDB.database.ref('/geofirePlace/');
        this.geoFire = new __WEBPACK_IMPORTED_MODULE_8_geofire__(this.dbRef);
        this.geoqueryU = this.geoFire.query({
            center: [lat, lng],
    ...
    FindridePassPage.prototype.setGeofireOr = function (radius, lat, lng, userId) {
    ...
    FindridePassPage.prototype.keyEnteredOr = function (userId) {
    ...
    FindridePassPage.prototype.setGeofireOrLMU = function (radius, lat, lng, userId) {
    ...
    FindridePassPage.prototype.keyEnteredOrLMU = function (userId) {
    ...
    FindridePassPage.prototype.keyExitedOrLMU = function (userId) {
        this.geoquery2LMU.on("key_exited", function (key) {
            this.afDB.database.ref('/usersTest/' + userId + '/availableReserves/' + key).remove();
        }.bind(this));
    };
    FindridePassPage.prototype.setGeofireDest = function (radius, lat, lng, userId) {
    ...
    FindridePassPage.prototype.setGeofireDestLMU = function (radius, lat, lng, userId) {
    ...
    FindridePassPage.prototype.keyEnteredDestLMU = function (userId) {
    ...
    FindridePassPage.prototype.keyExitedDestLMU = function (userId) {
