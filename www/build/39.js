...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__listride__ = __webpack_require__(906);
...
var ListridePage = /** @class */ (function () {
    ...
    ListridePage.prototype.createCrew = function () {
        ...
        var modal = this.modalCtrl.create('CreateCrewPage', { latOr: this.latOr, lngOr: this.lngOr, latDest: this.latDest, lngDest: this.lngDest, indexesOfPointsAlongRoute: this.indexesOfPointsAlongRoute, pointsAlongRoute: this.pointsAlongRoute });
        modal.present();
    };
    ...
    ListridePage.prototype.joinCrew = function (crew) {
        var _this = this;
        var latLngOr = { lat: this.latOr, lng: this.lngOr };
        var latLngDest = { lat: this.latDest, lng: this.lngDest };
        var origin = { name: this.user.trips.origin[0], coords: latLngOr };
        var destination = { name: this.user.trips.destination[0], coords: latLngDest };
        var userToCrew = {
            origin: origin,
        ...
        this.afDB.database.ref('/crewsTest/' + crew.admin.userId + '/' + crew.crewId + '/members').push(userToCrew)
            ...
            _this.afDB.database.ref('/usersTest/' + _this.userUid + '/crewsIJoined/' + keyPushCrew)
                .update({
