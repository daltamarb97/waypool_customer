            ...
            _this.reservesService.getMyReserves(reserve.driverId, reserve.keyReserve)
                ...
                if (_this.reserve === undefined || _this.reserve === null) {
                    if (_this.onTrip === true) {
                        ...
                        _this.eliminateReserve(_this.userUid, reserve.keyTrip);
                    }
                }
                else {
                    //check if the driver sabotage the trip eliminating anyone
                    if (_this.reserve.pendingUsers == null || _this.reserve.pendingUsers == undefined) {
                        if (_this.onTrip === true) {
                            _this.reservesService.eliminateKeyUser(_this.userUid, reserve.keyTrip);
                            console.log("exitoso");
                        }
                        ...
                        if (_this.reserve.initiating === true) {
                            //check if trip has to be saved for records 
                            _this.onTrip = true;
                            _this.reservesService.setOnTrip(_this.userUid);
                        }
