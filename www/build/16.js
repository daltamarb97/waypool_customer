...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__findride__ = __webpack_require__(679);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ionic_native_geolocation__ = __webpack_require__(349);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_angularfire2_database__ = __webpack_require__(344);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__services_environment_service__ = __webpack_require__(350);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var FindridePage = /** @class */ (function () {
    function FindridePage(navCtrl, geolocation, zone, sendCoordsService, AngularFireAuth, alertCtrl, geofireService, SignUpService, modalCtrl, app, afDB, environmentService) {
        ...
        if (this.SignUpService.userUniversity == undefined) {
            ...
            modal.onDidDismiss(function (readyToStart) {
                if (readyToStart) {
                    ...
                    _this.SignUpService.getMyInfo(_this.user, _this.SignUpService.userUniversity).subscribe(function (user) {
                        ...
                        this.geoqueryU.on("key_entered", function (key) {
                            ...
                            this.afDB.database.ref(this.SignUpService.userUniversity + '/users/' + this.user + '/trips').update({
                                ...
                                _this.geocoder.geocode({ 'address': _this.orFirebase[0] }, function (results, status) {
                                    ...
                                    // turn geofire On
                                    _this.geofireService.setGeofireOr(_this.SignUpService.userUniversity, 2, _this.geocoordinatesOr.lat, _this.geocoordinatesOr.lng, _this.user);
                                    _this.geofireService.setGeofireOrLMU(_this.SignUpService.userUniversity, 2, _this.geocoordinatesOr.lat, _this.geocoordinatesOr.lng, _this.user);
                ...
                if (this.autocompleteMyDest.input == '' || this.autocompleteMyPos.input == '') {
                    ...
                    this.geoqueryU.on("key_entered", function (key) {
                        ...
                        this.afDB.database.ref(this.SignUpService.userUniversity + '/users/' + this.user).update({
                            ...
                            _this.afDB.database.ref(_this.SignUpService.userUniversity + '/users/' + _this.user + '/trips').update({
    ...
    FindridePage.prototype.geocoderDestinationCase = function () {
        ...
        this.geocoder.geocode({ 'address': this.desFirebase[0] }, function (results, status) {
            ...
            // turn geofire On
            _this.geofireService.setGeofireDest(_this.SignUpService.userUniversity, 2, _this.geocoordinatesDest.lat, _this.geocoordinatesDest.lng, _this.user);
            _this.geofireService.setGeofireDestLMU(_this.SignUpService.userUniversity, 2, _this.geocoordinatesDest.lat, _this.geocoordinatesDest.lng, _this.user);
    ...
    FindridePage = __decorate([
        ...
        __metadata("design:paramtypes", [typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["i" /* NavController */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["i" /* NavController */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_1__ionic_native_geolocation__["a" /* Geolocation */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__ionic_native_geolocation__["a" /* Geolocation */]) === "function" && _c || Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_0__angular_core__["M" /* NgZone */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_0__angular_core__["M" /* NgZone */]) === "function" && _d || Object, typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_3__services_sendCoords_service__["a" /* sendCoordsService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__services_sendCoords_service__["a" /* sendCoordsService */]) === "function" && _e || Object, typeof (_f = typeof __WEBPACK_IMPORTED_MODULE_4_angularfire2_auth__["AngularFireAuth"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4_angularfire2_auth__["AngularFireAuth"]) === "function" && _f || Object, typeof (_g = typeof __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["a" /* AlertController */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["a" /* AlertController */]) === "function" && _g || Object, typeof (_h = typeof __WEBPACK_IMPORTED_MODULE_5__services_geoFire_service__["a" /* geofireService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_5__services_geoFire_service__["a" /* geofireService */]) === "function" && _h || Object, typeof (_j = typeof __WEBPACK_IMPORTED_MODULE_6__services_signup_services__["a" /* SignUpService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_6__services_signup_services__["a" /* SignUpService */]) === "function" && _j || Object, typeof (_k = typeof __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["h" /* ModalController */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["h" /* ModalController */]) === "function" && _k || Object, typeof (_l = typeof __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["b" /* App */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["b" /* App */]) === "function" && _l || Object, typeof (_m = typeof __WEBPACK_IMPORTED_MODULE_7_angularfire2_database__["AngularFireDatabase"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_7_angularfire2_database__["AngularFireDatabase"]) === "function" && _m || Object, typeof (_o = typeof __WEBPACK_IMPORTED_MODULE_9__services_environment_service__["a" /* environmentService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_9__services_environment_service__["a" /* environmentService */]) === "function" && _o || Object])
    ], FindridePage);
    return FindridePage;
