...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__services_instances_service__ = __webpack_require__(341);
        ...
        this.myReservesId.forEach(function (reserve) {
            _this.reservesService.getMyReserves(_this.SignUpService.userUniversity, reserve.driverId, reserve.keyReserve).takeUntil(_this.unsubscribe)
                ...
                if (reserve === undefined || reserve === null) {
                    ...
                    _this.reservesService.getPendingUsers(_this.SignUpService.userUniversity, reserve.driverId, reserve.keyReserve).takeUntil(_this.unsubscribe)
