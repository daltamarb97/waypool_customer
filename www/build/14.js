...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__myride__ = __webpack_require__(629);
...
var MyridePage = /** @class */ (function () {
    ...
    MyridePage.prototype.recognizedMyNamePendingUsers = function (users, keyTrip, driverId) {
        ...
        users.forEach(function (user) {
            if (_this.userUid === user.userId) {
                _this.TripsService.pushItsMePendingUsers(_this.userUid, keyTrip, driverId);
            }
        });
    };
    MyridePage.prototype.recognizedMyNamePickedUpUsers = function (users, keyTrip, driverId) {
        ...
        users.forEach(function (user) {
            if (_this.userUid === user.userId) {
                _this.TripsService.pushItsMePickedUpUsers(_this.userUid, keyTrip, driverId);
            }
        });
    };
