    ...
    ListridePage.prototype.getAvailableReserves = function () {
        ...
        this.ReservesGeofire.forEach(function (reserveGeofire) {
            ...
            if (reserveGeofire.LMU == true) {
                _this.TripsService.getLastMinuteTripsDEMO(_this.SignUpService.userUniversity, reserveGeofire.driverId).takeUntil(_this.unsubscribe)
                    .subscribe(function (reserveLMU) {
