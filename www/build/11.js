...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__type_of_login__ = __webpack_require__(888);
...
var TypeOfLoginPage = /** @class */ (function () {
    function TypeOfLoginPage(navCtrl, navParams, alertCtrl) {
            ...
            buttons: [
                {
                    text: 'Estoy Seguro',
                    handler: function () {
                        _this.navCtrl.push('SignupPage', { typeOfSignUp: 'personal' });
                    }
                },
                {
