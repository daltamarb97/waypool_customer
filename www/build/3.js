...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__findride__ = __webpack_require__(905);
                            ...
                            _this.afDB.database.ref('/usersTest/' + _this.userUid + '/trips').update({
                                ...
                                setTimeout(function () {
                                    if (_this.geofireOriginConfirmed === false && _this.geofireOriginConfirmedOnRoute === false && _this.geofireOriginCrewConfirmed === false && _this.geofireOriginCrewConfirmedOnRoute === false) {
                                        ...
                                        if (_this.usingGeolocation === true) {
                                            _this.navCtrl.push('ListridePage', { latOr: _this.myLatLngOr.lat, lngOr: _this.myLatLngOr.lng, latDest: _this.myLatLngDest.lat(), lngDest: _this.myLatLngDest.lng(), pointsAlongRoute: _this.pointsAlongRoute, indexesOfPointsAlongRoute: _this.indexesOfPointsAlongRoute, nameOr: _this.orFirebase, nameDest: _this.desFirebase });
                                        }
                                        else {
                                            _this.navCtrl.push('ListridePage', { latOr: _this.myLatLngOr.lat(), lngOr: _this.myLatLngOr.lng(), latDest: _this.myLatLngDest.lat(), lngDest: _this.myLatLngDest.lng(), pointsAlongRoute: _this.pointsAlongRoute, indexesOfPointsAlongRoute: _this.indexesOfPointsAlongRoute, nameOr: _this.orFirebase, nameDest: _this.desFirebase });
                                        }
