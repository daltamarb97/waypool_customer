...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__driverFindride__ = __webpack_require__(906);
...
var DriverFindridePage = /** @class */ (function () {
    function DriverFindridePage(geofireService, TripsService, afDB, navCtrl, SignUpService, modalCtrl, authenticationService, geolocation, zone, sendCoordsService, AngularFireAuth, alertCtrl, toastCtrl, app, sendUsersService, instancesService, firebaseNative, platform, fcm, loadingCtrl, renderer) {
            ...
            if (snap.val().toggleOnline) {
                ...
                _this.afDB.database.ref('allCities/' + snap.val().city + '/allPlaces/' + snap.val().place).once('value').then(function (snapshot) {
                    ...
                    _this.SignUpService.getMyInfo(_this.SignUpService.userPlace, _this.user).subscribe(function (user) {
                        ...
                        console.log(_this.userInfo);
                        _this.userInfo;
                        _this.toggleStatus = _this.userInfo.toggleStatus;
    ...
    DriverFindridePage.prototype.LoadMapWithHouseAdress = function (positionOr) {
        var _this = this;
    ...
    DriverFindridePage.prototype.conectDriver = function () {
        var _this = this;
                            ...
                            try {
                                ...
                                if (this.autocompleteMyPos.input == '' || this.autocompleteMyDest.input == '') {
                                    ...
                                    this.afDB.database.ref(this.SignUpService.userPlace + '/drivers/' + this.user + '/houseAddress/').update({
                                        ...
                                        // start modal
                                        var modal = _this.modalCtrl.create('DriverConfirmpricePage');
    ...
    DriverFindridePage.prototype.disconectDriver = function () {
        var _this = this;
    ...
    ////////Markers
    DriverFindridePage.prototype.clearMarkersDest = function () {
        for (var i = 0; i < this.markersDest.length; i++) {
            this.markersDest[i].setMap(null);
        }
        this.markersDest = [];
    };
    DriverFindridePage.prototype.clearMarkersOr = function () {
    ...
    DriverFindridePage.prototype.confirmPrice = function (houseAddr, placeAddr) {
        this.doGeoquery = false;
        var modal = this.modalCtrl.create('DriverConfirmpricePage', { houseAddr: houseAddr, placeAddr: placeAddr });
        modal.present();
    };
    ...
    DriverFindridePage.prototype.disable = function () {
    ...
    DriverFindridePage.prototype.enable = function () {
        var inputs = document.getElementById("input").getElementsByTagName("INPUT");
    ...
    DriverFindridePage.prototype.showPopup = function () {
        var profileModal = this.modalCtrl.create('DriverSuccessNotificationPage');
        profileModal.present();
    };
    DriverFindridePage.prototype.alertOffline = function () {
        var _this = this;
        var alert = this.alertCtrl.create({
            ...
            buttons: [
                {
                    ...
                    handler: function () {
                        _this.navCtrl.push('DriverReservetripPage');
                    }
                },
                {
                    text: 'Offline :(',
    ...
    DriverFindridePage.prototype.changeColorOnline = function () {
    ...
    DriverFindridePage.prototype.changeColorOffline = function () {
        // this.renderer.setElementStyle(this.buttonDshowConectedButton.nativeElement,'border-width','2px')
    ...
    DriverFindridePage.prototype.pushOriginPage = function () {
        this.navCtrl.push('DriverSpecifyOriginPage');
    };
    DriverFindridePage.prototype.CreateOneTrip = function () {
    ...
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_8" /* ViewChild */])('buttonDshowConectedButton', { read: __WEBPACK_IMPORTED_MODULE_0__angular_core__["t" /* ElementRef */] }),
        __metadata("design:type", Object)
    ], DriverFindridePage.prototype, "buttonDshowConectedButton", void 0);
    DriverFindridePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'driver-page-findride',template:/*ion-inline-start:"C:\Users\danie\waypool_costumer\src\pages\findride\driverFindride.html"*/'<ion-header class="bg-theme-driver"  >\n\n    \n\n    <ion-navbar  >\n\n        <button ion-button menuToggle>\n\n            <ion-icon name="menu" style="color: white;"></ion-icon>\n\n          \n\n          </button>\n\n          <!-- <ion-avatar ion-button menuToggle>\n\n            <img style="height:100%; width:100%" src="assets/imgs/menu.png">\n\n        </ion-avatar> -->\n\n          <ion-buttons style="display: flex; justify-content: center;"> \n\n              <ion-item style="background-color: transparent;">\n\n                <!-- <ion-toggle [(ngModel)]="isConected" [checked]="isConected" (ionChange)="conectDriver()"></ion-toggle> -->\n\n\n\n                  <!-- <div><p class="text-white">Conectado</p></div> -->\n\n              \n\n                  <ion-row class="center-align row" style="margin-left: 16px; justify-content: flex-end;" >\n\n                    \n\n                      <button  #buttonDisconected class="btn bg-theme rounded text-white buttonDisconected" style="border-radius:25px; height: 40px;"  *ngIf="showConectedButton" (click)="conectDriver()" >\n\n                        <ion-icon  name="calendar"></ion-icon>\n\n                           PUBLICAR HORARIO\n\n\n\n                      </button>\n\n                      <button #buttonConected  class="btn  text-white buttonConected" (click)="disconectDriver()" style="border-radius: 25px;height: 40px; border-color: green;" *ngIf="!showConectedButton" >\n\n                        <ion-icon  name="calendar"></ion-icon>\n\n\n\n                        HORARIO PUBLICADO </button>\n\n                    \n\n                    \n\n                </ion-row>\n\n              </ion-item>\n\n\n\n           \n\n \n\n          </ion-buttons> \n\n       \n\n    </ion-navbar>\n\n\n\n</ion-header>\n\n\n\n\n\n\n\n\n\n<ion-content  padding>\n\n\n\n      <ion-card class="search" >\n\n          <ion-card-content>\n\n\n\n              <span class="dot bg-theme-driver"></span>\n\n              <ion-searchbar required [(ngModel)]="autocompleteMyPos.input" id="input" [animated]=true (ionInput)="updateSearchResultsMyPos()"  placeholder="Cóloca tu origen"></ion-searchbar>\n\n\n\n              <ion-list   [hidden]="autocompleteItems.length == 0">\n\n                  <ion-item  *ngFor="let item of autocompleteItems" tappable (click)="selectSearchResultMyPos(item)">\n\n                    {{ item.description }}\n\n                  </ion-item>\n\n                </ion-list>\n\n                <!-- <ion-icon name="md-locate" (click)="getPositionAndMarker()" class="text-black"></ion-icon> -->\n\n          </ion-card-content>\n\n\n\n          <ion-card-content>\n\n\n\n              <span class="dot bg-yellow"></span>           \n\n             <ion-searchbar  [(ngModel)]="autocompleteMyDest.input"  id="input2" (click)="updateSearchResultsMyDest()" placeholder="Cóloca tu destino"></ion-searchbar>\n\n  \n\n  \n\n              <ion-list   *ngIf="showList">\n\n              <ion-item class="item" *ngFor="let item of multipleDestinations" tappable (click)="selectSearchResultMyDest(item)">\n\n                {{ item.name }}\n\n              </ion-item>\n\n            </ion-list>\n\n            \n\n           </ion-card-content>\n\n           \n\n      </ion-card>\n\n      <div style="display: flex; justify-content: center;">\n\n        <button (click)="CreateOneTrip()" class="btn rounded bg-theme text-white " style="width: 50%">Publicar Viaje</button>   \n\n      </div>\n\n      <!-- <ion-avatar item-end>\n\n          <img style="height: 15%; width: 15%;" src="assets/imgs/centermap.png" (click)="centerMap()">\n\n      </ion-avatar> -->\n\n  \n\n   <div #map id="map"></div>  \n\n     \n\n\n\n  \n\n            <div *ngIf="onTrip" >\n\n              <button class="btn rounded bg-theme-driver text-white animated infinite pulse" style=" width: 100% ;\n\n              position: fixed ;\n\n              bottom: 0px ;\n\n              left: 0px ;\n\n              height: 51px; \n\n              font-size: large;\n\n              \n\n          " (click)="goToTrip() " >VIAJE EN CURSO\n\n              </button>\n\n          </div>\n\n     \n\n  \n\n \n\n    \n\n   \n\n    \n\n\n\n\n\n \n\n</ion-content>\n\n\n\n'/*ion-inline-end:"C:\Users\danie\waypool_costumer\src\pages\findride\driverFindride.html"*/
        }),
