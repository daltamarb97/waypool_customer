...
var ConfirmpopupPage = /** @class */ (function () {
    ...
    ConfirmpopupPage.prototype.goToRide = function () {
        ...
        if (this.reservesWhereIam.length >= 5) {
            ...
            this.geoFireService.joinReserve(this.SignUpService.userPlace, this.reserve.keyTrip, this.reserve.driver.userId, this.userUid, this.user.trips.origin, this.user.trips.destination, this.user.name, this.user.lastname, this.user.phone, this.user.verifiedPerson);
