...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__driverMyride__ = __webpack_require__(898);
...
var DriverMyridePageModule = /** @class */ (function () {
    function DriverMyridePageModule() {
    }
    DriverMyridePageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__driverMyride__["a" /* DriverMyridePage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__driverMyride__["a" /* DriverMyridePage */]),
            ],
            exports: [
                __WEBPACK_IMPORTED_MODULE_2__driverMyride__["a" /* DriverMyridePage */]
            ]
        })
    ], DriverMyridePageModule);
    return DriverMyridePageModule;
}());

//# sourceMappingURL=driverMyride.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return DriverMyridePage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(59);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services_d_sendCoords_service__ = __webpack_require__(348);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_moment__ = __webpack_require__(709);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13_rxjs_operators__ = __webpack_require__(37);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var DriverMyridePage = /** @class */ (function () {
    function DriverMyridePage(navCtrl, geolocation, SignUpService, actionSheetCtrl, TripsService, modalCtrl, toastCtrl, alertCtrl, navParams, callNumber, sendCoordsService, AngularFireAuth, sendUsersService, geofireServices, afDB) {
        ...
        this.afDB.database.ref('/driversTest/' + this.driverUid + '/').once('value').then(function (snap) {
            var obj = snap.val();
            console.log(obj);
    ...
    DriverMyridePage.prototype.getPendingAndPickedUpUsers = function (keyTrip, driverUid) {
        var _this = this;
        this.TripsService.getPendingUsers(keyTrip, driverUid).takeUntil(this.unsubscribe)
            ...
            if (_this.pendingUsers.length === 0 && _this.pickedUpUsers.length === 0) {
                ...
                _this.PendingUsersForWaypoints.forEach(function (user) {
                    _this.waypoints.push({ location: user.origin.coords, stopover: true });
        ...
        this.TripsService.getPickedUpUsers(keyTrip, driverUid).takeUntil(this.unsubscribe)
            ...
            if (_this.pendingUsers.length === 0 && user.length !== 0) {
                ...
                _this.pickedUpUsersForWaypoints.forEach(function (user) {
                    _this.waypoints.push({ location: user.destination.coords, stopover: true });
                    _this.directionsDisplay.setMap(_this.map);
    ...
    DriverMyridePage.prototype.conditionalsOnTrip = function () {
        ...
        if (this.trip.pendingUsers === undefined && this.trip.pickedUpUsers === undefined && this.trip.cancelUsers === undefined) {
            ...
            this.afDB.database.ref('/tripsTest/' + this.driverUid + '/' + this.userDriver.keyTrip).remove().then(function () {
    ...
    DriverMyridePage.prototype.callUser = function (number) {
        var _this = this;
    ...
    DriverMyridePage.prototype.unSubscribeServices = function () {
        this.unsubscribe.next();
        this.unsubscribe.complete();
    };
    DriverMyridePage.prototype.goToRide = function (user) {
        this.navCtrl.push('DriverPickupPage', {
            user: user,
            keyTrip: this.userDriver.keyTrip
        });
    };
    DriverMyridePage.prototype.pickUpPassenger = function (user) {
    ...
    DriverMyridePage.prototype.endTrip = function () {
        var _this = this;
                ...
                buttons: [{
                    ...
                    },
                    {
                        ...
                        handler: function () {
                            ...
                            _this.afDB.database.ref('/tripsTest/' + _this.driverUid + '/' + _this.userDriver.keyTrip).update({
                                DestinationTime: today
                            }).then(function (snap) {
                                _this.unSubscribeServices();
                                _this.geofireServices.deleteUserGeofireOrTrip(_this.userDriver.keyTrip);
                                _this.geofireServices.deleteUserGeofireDestTrip(_this.userDriver.keyTrip);
                                _this.pickedUpUsers.forEach(function (user) {
                                    _this.TripsService.sentTripUser(user.userId, _this.trip);
                                    _this.TripsService.endTripForUsers(user.userId);
                                    _this.TripsService.setOnTripFalseUser(user.userId);
                                    _this.TripsService.eliminateKeyTripUser(user.userId);
                                    _this.TripsService.saveTripOnRecordsUser(user.userId, _this.trip, _this.userDriver.keyTrip);
                                ...
                                _this.TripsService.allTrips(_this.driverUid, _this.userDriver.keyTrip, _this.trip);
                                _this.TripsService.saveTripOnRecords(_this.driverUid, _this.trip, _this.userDriver.keyTrip);
                                ...
                                setTimeout(function () {
                                    _this.TripsService.eliminateTripState(_this.userDriver.keyTrip, _this.driverUid);
                            ...
                            _this.navCtrl.push('DriverRatetripPage', { user: _this.userDriver, trip: _this.trip });
                        }
                    }
                ]
            });
    ...
    DriverMyridePage.prototype.enterChat = function () {
    ...
    DriverMyridePage.prototype.presentToast = function (message, duration, position) {
    ...
    DriverMyridePage.prototype.presentAlert = function (title, text, button) {
    ...
    DriverMyridePage.prototype.deleteUser = function (userId, nameUser) {
        var _this = this;
        var alert = this.alertCtrl.create({
            ...
            buttons: [{
                ...
                },
                {
                    ...
                    handler: function () {
                        ...
                        _this.TripsService.setOnTripFalseUser(userId);
                        _this.TripsService.eliminateKeyTripUser(userId);
    ...
    DriverMyridePage.prototype.presentActionSheet = function (userId, nameUser) {
        var _this = this;
    ...
    DriverMyridePage.prototype.help = function () {
        var toast = this.toastCtrl.create({
...
//# sourceMappingURL=driverMyride.js.map
