...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__tripbike__ = __webpack_require__(813);
...
var TripbikePageModule = /** @class */ (function () {
    function TripbikePageModule() {
    }
    TripbikePageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__tripbike__["a" /* TripbikePage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__tripbike__["a" /* TripbikePage */]),
            ],
            exports: [
                __WEBPACK_IMPORTED_MODULE_2__tripbike__["a" /* TripbikePage */]
            ]
    ...
    return TripbikePageModule;
}());

//# sourceMappingURL=tripbike.module.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_moment__ = __webpack_require__(659);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_moment___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6_moment__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__services_trips_service__ = __webpack_require__(350);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_rxjs__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_angularfire2_database__ = __webpack_require__(346);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__services_signup_services__ = __webpack_require__(199);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11_rxjs_operators__ = __webpack_require__(42);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__services_metrics_service__ = __webpack_require__(352);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var TripbikePage = /** @class */ (function () {
    function TripbikePage(navCtrl, alertCtrl, MetricsService, TripsService, toastCtrl, callNumber, navParams, SignUpService, geolocation, zone, sendCoordsService, AngularFireAuth, afDB) {
    ...
    TripbikePage.prototype.ionViewDidLoad = function () {
        this.loadMap();
    };
    TripbikePage.prototype.loadMap = function () {
    ...
    TripbikePage.prototype.addMarker = function (coordsForMarker) {
        var marker = new google.maps.Marker({
    ...
    //   }
    // }
    TripbikePage.prototype.clearMarkers = function () {
        this.setMapOnAll(null);
    };
    TripbikePage.prototype.setMapOnAll = function (map) {
        for (var i = 0; i < this.markers.length; i++) {
            this.markers[i].setMap(map);
        }
    };
    TripbikePage.prototype.deleteMarkers = function () {
        this.clearMarkers();
        this.markers = [];
    };
    TripbikePage.prototype.unSubscribeServices = function () {
        this.unsubscribe.next();
        this.unsubscribe.complete();
    };
    TripbikePage.prototype.finishTrip = function () {
        //stop tracking the location and finishing trip
        __WEBPACK_IMPORTED_MODULE_6_moment__["locale"]('es'); //to make the date be in spanish  
        var today = __WEBPACK_IMPORTED_MODULE_6_moment__().format('MMMM Do , h:mm:ss a'); //set actual date
    ...
    TripbikePage.prototype.cancelTrip = function () {
        var _this = this;
    ...
    TripbikePage.prototype.ionViewDidLeave = function () {
        this.unsubscribe.next();
        this.unsubscribe.complete();
    };
    TripbikePage.prototype.presentToast = function (message, duration, position) {
    ...
    TripbikePage.prototype.presentAlert = function (title, text, button) {
        var alert = this.alertCtrl.create({
            title: title,
            subTitle: text,
            buttons: [button]
    ...
    TripbikePage.prototype.help = function () {
        var toast = this.toastCtrl.create({
