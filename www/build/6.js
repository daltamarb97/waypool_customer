...
var VerificationImagesPage = /** @class */ (function () {
    ...
    VerificationImagesPage.prototype.usageCameraCarne = function () {
        ...
        this.camera.getPicture(this.options).then(function (imageData) {
            ...
            var picturesDrivers = Object(__WEBPACK_IMPORTED_MODULE_3_firebase__["storage"])().ref('verificationDocuments/' + _this.user + '/' + _this.data);
