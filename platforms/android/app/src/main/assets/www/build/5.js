...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_moment__ = __webpack_require__(706);
...
var DriverMyridePage = /** @class */ (function () {
    ...
    DriverMyridePage.prototype.conditionalsOnTrip = function () {
        ...
        if (this.trip.pendingUsers === undefined && this.trip.pickedUpUsers === undefined && this.trip.cancelUsers === undefined) {
            ...
            this.afDB.database.ref(this.SignUpService.userPlace + '/tripsTest/' + this.driverUid + '/' + this.userDriver.keyTrip).remove().then(function () {
                ...
                buttons: [{
                    ...
                    },
                    {
                        ...
                        handler: function () {
                            ...
                            _this.afDB.database.ref(_this.SignUpService.userPlace + '/tripsTest/' + _this.driverUid + '/' + _this.userDriver.keyTrip).update({
